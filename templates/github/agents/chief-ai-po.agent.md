---
name: chief-ai-po
description: AI Product Owner agent. Three modes — decompose (PRD to stories), refine (enrich story with AI acceptance criteria for TRIAGE), incorporate-feedback (revise story from downstream agent feedback for REWORK). Runs on a separate thread.
